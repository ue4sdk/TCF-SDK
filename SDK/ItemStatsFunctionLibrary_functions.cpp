...
#include "ItemStatsFunctionLibrary_classes.hpp"
...
// Function ItemStatsFunctionLibrary.ItemStatsFunctionLibrary_C.ShouldRoundToInt
...
void UItemStatsFunctionLibrary_C::ShouldRoundToInt(EYItemStatsType Type, class UObject* __WorldContext, bool* Return)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function ItemStatsFunctionLibrary.ItemStatsFunctionLibrary_C.ShouldRoundToInt"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function ItemStatsFunctionLibrary.ItemStatsFunctionLibrary_C.DetemineSuffix"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function ItemStatsFunctionLibrary.ItemStatsFunctionLibrary_C.ShowAsPercentage"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function ItemStatsFunctionLibrary.ItemStatsFunctionLibrary_C.IsHigherStatPositive"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function ItemStatsFunctionLibrary.ItemStatsFunctionLibrary_C.DetermineForcedMaxFloatFractionDigits"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function ItemStatsFunctionLibrary.ItemStatsFunctionLibrary_C.ShouldDisplayAsTextInsteadOfFloat"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function ItemStatsFunctionLibrary.ItemStatsFunctionLibrary_C.TransformFloatToText"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function ItemStatsFunctionLibrary.ItemStatsFunctionLibrary_C.FormatTextString"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function ItemStatsFunctionLibrary.ItemStatsFunctionLibrary_C.SetupTextWidgetsBasedOnItemStats"));
