...
#include "TCF_AnimNotify_AIPreExplode_classes.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AnimNotify_AIPreExplode.AnimNotify_AIPreExplode_C.Received_Notify");
