...
#include "TCF_YHUD_Login_BP_structs.hpp"
...
// BlueprintGeneratedClass YHUD_Login_BP.YHUD_Login_BP_C
// 0x0010 (0x03C8 - 0x03B8)
class AYHUD_Login_BP_C : public AYHUD
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass YHUD_Login_BP.YHUD_Login_BP_C");
		return ptr;
	}
