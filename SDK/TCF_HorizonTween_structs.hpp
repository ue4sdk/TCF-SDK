...
#include "TCF_HorizonTween_enums.hpp"
...
struct FHorizonTweenEventTransformParam
{
	...
	struct FHitResult                                  SweepHitResult;                                           // 0x0008(0x008C) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData, CPF_NoDestructor, CPF_ContainsInstancedReference, CPF_NativeAccessSpecifierPublic)
};
...
struct FHorizonTweenEventVectorParameters : public FHorizonTweenEventTweenListImplementParameters
{
	...
	struct FHorizonTweenEventTransformParam            TransformParam;                                           // 0x002C(0x0094) (CPF_Edit, CPF_BlueprintVisible, CPF_NoDestructor, CPF_ContainsInstancedReference, CPF_NativeAccessSpecifierPublic)
...
struct FHorizonTweenEventSplinePathParameters : public FHorizonTweenEventImplementParameters
{
	...
	struct FHorizonTweenEventTransformParam            TransformParam;                                           // 0x0018(0x0094) (CPF_Edit, CPF_BlueprintVisible, CPF_NoDestructor, CPF_ContainsInstancedReference, CPF_NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData02[0x4];                                       // 0x00AC(0x0004) MISSED OFFSET
	struct FHorizonTweenEventCustomCurve               CustomTweenCurve;                                         // 0x00B0(0x0088) (CPF_Edit, CPF_BlueprintVisible, CPF_NativeAccessSpecifierPublic)
};
...
{
	TWeakObjectPtr<class AActor>                       TweenTargetWeakPtr;                                       // 0x0138(0x0008) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_UObjectWrapper, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
};
...
{
	TWeakObjectPtr<class UWidget>                      TweenTargetWeakPtr;                                       // 0x0138(0x0008) (CPF_BlueprintVisible, CPF_ExportObject, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData, CPF_NoDestructor, CPF_UObjectWrapper, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
	bool                                               bTweenSheer;                                              // 0x0140(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
...
{
	TWeakObjectPtr<class USceneComponent>              TweenTargetWeakPtr;                                       // 0x0138(0x0008) (CPF_BlueprintVisible, CPF_ExportObject, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData, CPF_NoDestructor, CPF_UObjectWrapper, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
};
