...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Map_WBP.Map_WBP_C.OnMouseMove"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Map_WBP.Map_WBP_C.OnMouseButtonDown"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Map_WBP.Map_WBP_C.SaveTexture"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Map_WBP.Map_WBP_C.BP_SetZoom"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Map_WBP.Map_WBP_C.BP_OnProjectionSizeChangeRequest"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Map_WBP.Map_WBP_C.Construct"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Map_WBP.Map_WBP_C.ExecuteUbergraph_Map_WBP"));
