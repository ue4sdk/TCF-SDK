...
#include "TCF_AnimNotify_FootStepFX_classes.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AnimNotify_FootStepFX.AnimNotify_FootStepFX_C.Received_Notify");
