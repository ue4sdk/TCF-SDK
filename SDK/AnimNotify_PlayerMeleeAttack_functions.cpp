...
#include "AnimNotify_PlayerMeleeAttack_classes.hpp"
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AnimNotify_PlayerMeleeAttack.AnimNotify_PlayerMeleeAttack_C.Received_NotifyEnd"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AnimNotify_PlayerMeleeAttack.AnimNotify_PlayerMeleeAttack_C.Received_NotifyBegin"));
