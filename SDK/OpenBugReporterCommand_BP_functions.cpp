...
#include "OpenBugReporterCommand_BP_classes.hpp"
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function OpenBugReporterCommand_BP.OpenBugReporterCommand_BP_C.BP_IsAvailable"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function OpenBugReporterCommand_BP.OpenBugReporterCommand_BP_C.BP_OnExecute"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function OpenBugReporterCommand_BP.OpenBugReporterCommand_BP_C.ExecuteUbergraph_OpenBugReporterCommand_BP"));
