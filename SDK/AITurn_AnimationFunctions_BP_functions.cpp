...
#include "AITurn_AnimationFunctions_BP_classes.hpp"
...
// struct FYAITurnAnimation       TurnAnimation                  (CPF_Parm, CPF_OutParm, CPF_NoDestructor)
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AITurn_AnimationFunctions_BP.AITurn_AnimationFunctions_BP_C.FindBestAngle"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AITurn_AnimationFunctions_BP.AITurn_AnimationFunctions_BP_C.DetermineTurnAnimation"));
