...
#include "SceneQuickMenuBase_BP_structs.hpp"
...
public:
	...
	class UWBP_Transition_C*                           TransitionWidget;                                         // 0x0440(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_InstancedReference, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass SceneQuickMenuBase_BP.SceneQuickMenuBase_BP_C"));
		return ptr;
	}
