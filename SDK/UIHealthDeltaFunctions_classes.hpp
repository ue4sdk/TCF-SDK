...
#include "UIHealthDeltaFunctions_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass UIHealthDeltaFunctions.UIHealthDeltaFunctions_C"));
		return ptr;
	}
