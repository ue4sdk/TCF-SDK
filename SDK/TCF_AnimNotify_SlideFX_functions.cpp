...
#include "TCF_AnimNotify_SlideFX_classes.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AnimNotify_SlideFX.AnimNotify_SlideFX_C.Received_Notify");
