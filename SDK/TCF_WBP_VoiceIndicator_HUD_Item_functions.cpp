...
#include "TCF_WBP_VoiceIndicator_HUD_Item_classes.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_VoiceIndicator_HUD_Item.WBP_VoiceIndicator_HUD_Item_C.Tick"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_VoiceIndicator_HUD_Item.WBP_VoiceIndicator_HUD_Item_C.ExecuteUbergraph_WBP_VoiceIndicator_HUD_Item"));
