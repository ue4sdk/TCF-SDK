...
{
	class UClass*                                      ControlRigClass;                                          // 0x0170(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_UObjectWrapper, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPrivate)
...
{
	class UClass*                                      ControlRigClass;                                          // 0x0000(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_UObjectWrapper, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPrivate)
};
...
{
	unsigned char                                      UnknownData00[0x2B0];                                     // 0x0A00(0x02B0) MISSED OFFSET
};
...
{
	TArray<struct FCachedRigElement>                   BoneIndices;                                              // 0x0000(0x0010) (CPF_ZeroConstructor, CPF_Transient, CPF_NativeAccessSpecifierPublic)
