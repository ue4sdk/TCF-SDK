...
#include "MapMarker_Vehicle_WBP_classes.hpp"
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function MapMarker_Vehicle_WBP.MapMarker_Vehicle_WBP_C.ShouldUpdate"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function MapMarker_Vehicle_WBP.MapMarker_Vehicle_WBP_C.BP_OnUpdateMarkerData"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function MapMarker_Vehicle_WBP.MapMarker_Vehicle_WBP_C.ExecuteUbergraph_MapMarker_Vehicle_WBP"));
