...
#include "TCF_BTDecorator_ShouldAIRoar_classes.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BTDecorator_ShouldAIRoar.BTDecorator_ShouldAIRoar_C.PerformConditionCheckAI");
