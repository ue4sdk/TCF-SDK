...
#include "EQSContext_HigherBetweenCombatTargetAndQuerier_classes.hpp"
...
// Function EQSContext_HigherBetweenCombatTargetAndQuerier.EQSContext_HigherBetweenCombatTargetAndQuerier_C.ProvideSingleActor
...
void UEQSContext_HigherBetweenCombatTargetAndQuerier_C::ProvideSingleActor(class UObject* QuerierObject, class AActor* QuerierActor, class AActor** ResultingActor)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function EQSContext_HigherBetweenCombatTargetAndQuerier.EQSContext_HigherBetweenCombatTargetAndQuerier_C.ProvideSingleActor"));
