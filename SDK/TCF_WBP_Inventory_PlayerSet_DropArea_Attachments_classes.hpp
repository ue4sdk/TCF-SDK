...
#include "TCF_WBP_Inventory_PlayerSet_DropArea_Attachments_structs.hpp"
...
public:
	...
	struct FString                                     weaponItemId;                                             // 0x0270(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_HasGetValueTypeHash)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>("WidgetBlueprintGeneratedClass WBP_Inventory_PlayerSet_DropArea_Attachments.WBP_Inventory_PlayerSet_DropArea_Attachments_C");
		return ptr;
	}
