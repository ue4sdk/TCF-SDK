...
#include "MapMarker_AreaName_WBP_structs.hpp"
...
public:
	...
	class URichTextBlock*                              Txt_TitleLabel;                                           // 0x02F8(0x0008) (CPF_BlueprintVisible, CPF_ExportObject, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData, CPF_RepSkip, CPF_NoDestructor, CPF_PersistentInstance, CPF_HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("WidgetBlueprintGeneratedClass MapMarker_AreaName_WBP.MapMarker_AreaName_WBP_C"));
		return ptr;
	}
