...
#include "TCF_WBP_EndOfMatch_DamageDetailInfo_classes.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_EndOfMatch_DamageDetailInfo.WBP_EndOfMatch_DamageDetailInfo_C.GetDamageApplyInfoRow"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_EndOfMatch_DamageDetailInfo.WBP_EndOfMatch_DamageDetailInfo_C.GetDamageItemId"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_EndOfMatch_DamageDetailInfo.WBP_EndOfMatch_DamageDetailInfo_C.OnLoaded_705BACF749A38B5BCD51009EAF85A069"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_EndOfMatch_DamageDetailInfo.WBP_EndOfMatch_DamageDetailInfo_C.SetupIconTexture"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_EndOfMatch_DamageDetailInfo.WBP_EndOfMatch_DamageDetailInfo_C.SetupDamageInfoDetail"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_EndOfMatch_DamageDetailInfo.WBP_EndOfMatch_DamageDetailInfo_C.CollapseAllDynamicElements"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_EndOfMatch_DamageDetailInfo.WBP_EndOfMatch_DamageDetailInfo_C.SetupDamageSourceName"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_EndOfMatch_DamageDetailInfo.WBP_EndOfMatch_DamageDetailInfo_C.ExecuteUbergraph_WBP_EndOfMatch_DamageDetailInfo"));
