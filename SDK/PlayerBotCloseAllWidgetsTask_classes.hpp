...
#include "PlayerBotCloseAllWidgetsTask_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass PlayerBotCloseAllWidgetsTask.PlayerBotCloseAllWidgetsTask_C"));
		return ptr;
	}
