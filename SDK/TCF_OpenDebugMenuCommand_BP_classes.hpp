...
#include "TCF_OpenDebugMenuCommand_BP_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass OpenDebugMenuCommand_BP.OpenDebugMenuCommand_BP_C");
		return ptr;
	}
