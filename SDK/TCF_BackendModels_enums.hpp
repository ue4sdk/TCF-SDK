...
enum class EYCheatResult : uint8_t
{
	...
	EYCheatResult__EYCheatResult_MAX = 4
};
...
enum class EYClaimContractRewardsStatus : uint8_t
{
	...
	EYClaimContractRewardsStatus__OK = 16,
	EYClaimContractRewardsStatus__MAX = 17
};
...
enum class EYActivateContractRequestStatus : uint8_t
{
	...
	EYActivateContractRequestStatus__OK = 11,
	EYActivateContractRequestStatus__MAX = 12
};
...
enum class EYScrapItemResult : uint8_t
{
	EYScrapItemResult__OK          = 0,
	EYScrapItemResult__ITEM_MISSING = 1,
	EYScrapItemResult__INVALID_TYPE = 2,
	EYScrapItemResult__STARTING_ITEM = 3,
	EYScrapItemResult__NO_BLUEPRINT = 4,
	EYScrapItemResult__NO_SCRAPPING_RULE = 5,
	EYScrapItemResult__UNKNOWN_ERROR = 6,
	EYScrapItemResult__EYScrapItemResult_MAX = 7
};


// Enum BackendModels.EYClaimCraftedItemStatus
enum class EYClaimCraftedItemStatus : uint8_t
{
	EYClaimCraftedItemStatus__UNKNOWN_ERROR = 0,
	EYClaimCraftedItemStatus__OK   = 1,
	EYClaimCraftedItemStatus__BLUEPRINT_DATA_NOT_FOUND = 2,
	EYClaimCraftedItemStatus__FAILED_GETTING_INVENTORY = 3,
	EYClaimCraftedItemStatus__FAILED_GETTING_ITEM_CUSTOM_DATA = 4,
	EYClaimCraftedItemStatus__FAILED_GETTING_PLAYER_SET = 5,
	EYClaimCraftedItemStatus__FAILED_GRANTING_OR_UPDATING_ITEM = 6,
	EYClaimCraftedItemStatus__ITEM_CURRENTLY_CRAFTED_NOT_FOUND = 7,
	EYClaimCraftedItemStatus__NOT_ENOUGH_RESOURCES = 8,
	EYClaimCraftedItemStatus__NO_ITEMS_GRANTED_OR_UPDATED = 9,
	EYClaimCraftedItemStatus__PRICE_CRAFTING_STATION_NOT_FOUND = 10,
	EYClaimCraftedItemStatus__RECIPE_DATA_NOT_FOUND = 11,
	EYClaimCraftedItemStatus__WRONG_ITEMID = 12,
	EYClaimCraftedItemStatus__WRONG_RARITY = 13,
	EYClaimCraftedItemStatus__WRONG_SHOPITEMBELONGSTO = 14,
	EYClaimCraftedItemStatus__WRONG_USERID = 15,
	EYClaimCraftedItemStatus__MAX  = 16
};
...
enum class EYStartItemCraftingResultStatus : uint8_t
{
	...
	EYStartItemCraftingResultStatus__ANOTHER_ITEM_IS_ALREADY_BEING_CRAFTED = 2,
	EYStartItemCraftingResultStatus__NOT_ENOUGH_RESOURCES = 3,
	EYStartItemCraftingResultStatus__PLAYER_INVENTORY_NOT_FOUND = 4,
	EYStartItemCraftingResultStatus__RECIPE_DATA_NOT_FOUND = 5,
	EYStartItemCraftingResultStatus__STASH_FULL = 6,
	EYStartItemCraftingResultStatus__WRONG_ITEMID = 7,
	EYStartItemCraftingResultStatus__WRONG_PURCHASE_AMOUNT = 8,
	EYStartItemCraftingResultStatus__WRONG_RARITY = 9,
	EYStartItemCraftingResultStatus__WRONG_SHOPITEMBELONGSTO = 10,
	EYStartItemCraftingResultStatus__WRONG_USERID = 11,
	EYStartItemCraftingResultStatus__MAX = 12
};
...
enum class EYClaimGeneratorIncomeStatus : uint8_t
{
	...
	EYClaimGeneratorIncomeStatus__FAILED_SETTING_LASTCLAIM_TIME = 2,
	EYClaimGeneratorIncomeStatus__MISSING_GENERATOR_ID = 3,
	EYClaimGeneratorIncomeStatus__NO_STATIC_DATA_GENERATOR = 4,
	EYClaimGeneratorIncomeStatus__NO_REWARDS_ACCRUED = 5,
	EYClaimGeneratorIncomeStatus__NO_REWARDS_DATA_FOUND = 6,
	EYClaimGeneratorIncomeStatus__NO_REWARDS_FOUND_IN_CRATE = 7,
	EYClaimGeneratorIncomeStatus__STASH_FULL = 8,
	EYClaimGeneratorIncomeStatus__MAX = 9
};
...
enum class EYCustomizationCategory : uint8_t
{
	...
	EYCustomizationCategory__Item  = 21,
	EYCustomizationCategory__Vehicle = 22,
	EYCustomizationCategory__Droppod = 23,
	EYCustomizationCategory__EYCustomizationCategory_MAX = 24
};
...
enum class EYVanityType : uint8_t
{
	...
	EYVanityType__Material         = 13,
	EYVanityType__MAX              = 14
};
...
enum class EYFriendActionResult : uint8_t
{
	...
	EYFriendActionResult__TARGET_OFFLINE = 2,
	EYFriendActionResult__INITIATOR_OFFLINE = 3,
	EYFriendActionResult__ALREADY_FRIEND = 4,
	EYFriendActionResult__NOT_IN_STATION = 5,
...
enum class EYSquadActionResult : uint8_t
{
	...
	EYSquadActionResult__EYSquadActionResult_MAX = 8
};
