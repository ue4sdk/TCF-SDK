...
#include "TCF_DeadDrop_BP_classes.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function DeadDrop_BP.DeadDrop_BP_C.GetDebugDescription"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function DeadDrop_BP.DeadDrop_BP_C.GetDebugText"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function DeadDrop_BP.DeadDrop_BP_C.UserConstructionScript"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function DeadDrop_BP.DeadDrop_BP_C.ReceiveBeginPlay"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function DeadDrop_BP.DeadDrop_BP_C.ExecuteUbergraph_DeadDrop_BP"));
