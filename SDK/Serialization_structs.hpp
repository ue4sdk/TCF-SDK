...
struct FStructSerializerBuiltinTestStruct
{
	...
	struct FText                                       Text;                                                     // 0x0028(0x0020) (CPF_NativeAccessSpecifierPublic)
	struct FVector                                     Vector;                                                   // 0x0048(0x000C) (CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData00[0xC];                                       // 0x0054(0x000C) MISSED OFFSET
	struct FVector4                                    Vector4;                                                  // 0x0060(0x0010) (CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
	struct FRotator                                    Rotator;                                                  // 0x0070(0x000C) (CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData01[0x4];                                       // 0x007C(0x0004) MISSED OFFSET
	struct FQuat                                       Quat;                                                     // 0x0080(0x0010) (CPF_IsPlainOldData, CPF_NoDestructor, CPF_NativeAccessSpecifierPublic)
	struct FCoreUObject_FColor                         Color;                                                    // 0x0090(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
...
struct FStructSerializerTestStruct
{
	...
	struct FStructSerializerBuiltinTestStruct          Builtins;                                                 // 0x00E0(0x00A0) (CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
	struct FStructSerializerArrayTestStruct            Arrays;                                                   // 0x0180(0x0060) (CPF_NativeAccessSpecifierPublic)
	struct FStructSerializerMapTestStruct              maps;                                                     // 0x01E0(0x0140) (CPF_NativeAccessSpecifierPublic)
	struct FStructSerializerSetTestStruct              Sets;                                                     // 0x0320(0x0140) (CPF_NativeAccessSpecifierPublic)
};
