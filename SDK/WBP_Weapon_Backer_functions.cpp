...
#include "WBP_Weapon_Backer_classes.hpp"
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function WBP_Weapon_Backer.WBP_Weapon_Backer_C.SetRarityColor"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function WBP_Weapon_Backer.WBP_Weapon_Backer_C.PreConstruct"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function WBP_Weapon_Backer.WBP_Weapon_Backer_C.ExecuteUbergraph_WBP_Weapon_Backer"));
