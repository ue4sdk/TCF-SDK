...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AL_AISpawning_BP.AL_AISpawning_BP_C.GetDebugDescription"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AL_AISpawning_BP.AL_AISpawning_BP_C.UserConstructionScript"));
