...
#include "NPC_Object_BP_structs.hpp"
...
public:
	...
	class UYObjectInteractionComponent*                YObjectInteraction;                                       // 0x02A8(0x0008) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData, CPF_NonTransactional, CPF_NoDestructor, CPF_HasGetValueTypeHash)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass NPC_Object_BP.NPC_Object_BP_C"));
		return ptr;
	}
