...
enum class EYMetaConverterTypes : uint8_t
{
	...
	EYMetaConverterTypes__DailyCrateUpgradeCosts = 13,
	EYMetaConverterTypes__FortunaPassActions = 14,
	EYMetaConverterTypes__FortunaPassSeasonLevels = 15,
	EYMetaConverterTypes__All      = 16,
	EYMetaConverterTypes__EYMetaConverterTypes_MAX = 17
};
