...
#include "TCF_YInitializationPlugin_classes.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function YInitializationPlugin.YInitializationManager.RequestCompleteInitializationCallbackBlueprint");
