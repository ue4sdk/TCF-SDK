...
#include "TCF_BTTask_Friendly_StopMoving_structs.hpp"
...
public:
	...
	struct FBlackboardKeySelector                      MyCurrentLocation;                                        // 0x00B0(0x0028) (CPF_Edit, CPF_BlueprintVisible)
	struct FBlackboardKeySelector                      Target;                                                   // 0x00D8(0x0028) (CPF_Edit, CPF_BlueprintVisible)
	struct FVector                                     currentLocation;                                          // 0x0100(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
