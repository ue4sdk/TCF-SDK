...
#include "YProjectile_NoPawnCollision_BP_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass YProjectile_NoPawnCollision_BP.YProjectile_NoPawnCollision_BP_C"));
		return ptr;
	}
