...
#include "TCF_BTTask_Friendly_Happy_structs.hpp"
...
public:
	...
	struct FBlackboardKeySelector                      IsCreatureHappy;                                          // 0x00B8(0x0028) (CPF_Edit, CPF_BlueprintVisible)
	struct FBlackboardKeySelector                      Alerted;                                                  // 0x00E0(0x0028) (CPF_Edit, CPF_BlueprintVisible, CPF_DisableEditOnInstance)
