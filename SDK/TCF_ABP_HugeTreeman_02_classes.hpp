...
#include "TCF_ABP_HugeTreeman_02_structs.hpp"
...
// AnimBlueprintGeneratedClass ABP_HugeTreeman_02.ABP_HugeTreeman_02_C
// 0x0200 (0x04C0 - 0x02C0)
class UABP_HugeTreeman_02_C : public UAnimInstance
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("AnimBlueprintGeneratedClass ABP_HugeTreeman_02.ABP_HugeTreeman_02_C"));
		return ptr;
	}


	void AnimGraph(struct FPoseLink* AnimGraph);
	void ExecuteUbergraph_ABP_HugeTreeman_02(int EntryPoint);
};
