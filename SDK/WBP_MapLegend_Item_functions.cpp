...
#include "WBP_MapLegend_Item_classes.hpp"
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function WBP_MapLegend_Item.WBP_MapLegend_Item_C.SetIconImage"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function WBP_MapLegend_Item.WBP_MapLegend_Item_C.PreConstruct"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function WBP_MapLegend_Item.WBP_MapLegend_Item_C.ExecuteUbergraph_WBP_MapLegend_Item"));
