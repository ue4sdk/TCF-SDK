...
#include "PlayerBotStopPerformanceCaptureTask_classes.hpp"
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function PlayerBotStopPerformanceCaptureTask.PlayerBotStopPerformanceCaptureTask_C.ReceiveExecute"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function PlayerBotStopPerformanceCaptureTask.PlayerBotStopPerformanceCaptureTask_C.ExecuteUbergraph_PlayerBotStopPerformanceCaptureTask"));
