...
#include "SceneQuickMenuBase_BP_classes.hpp"
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function SceneQuickMenuBase_BP.SceneQuickMenuBase_BP_C.GetPlayerControllerAndCharacter"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function SceneQuickMenuBase_BP.SceneQuickMenuBase_BP_C.BP_Initialize"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function SceneQuickMenuBase_BP.SceneQuickMenuBase_BP_C.BP_UnInitialize"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function SceneQuickMenuBase_BP.SceneQuickMenuBase_BP_C.ExecuteUbergraph_SceneQuickMenuBase_BP"));
