...
#include "AAM_PowerUp_BP_classes.hpp"
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AAM_PowerUp_BP.AAM_PowerUp_BP_C.GetSpecialDebugActors"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AAM_PowerUp_BP.AAM_PowerUp_BP_C.AddConfigurator"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AAM_PowerUp_BP.AAM_PowerUp_BP_C.ReceiveBeginPlay"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AAM_PowerUp_BP.AAM_PowerUp_BP_C.ExecuteUbergraph_AAM_PowerUp_BP"));
