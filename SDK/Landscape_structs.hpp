...
struct FGrassInput
{
	...
	struct FExpressionInput                            Input;                                                    // 0x0010(0x0014) (CPF_NoDestructor, CPF_NativeAccessSpecifierPublic)
...
struct FLayerBlendInput
{
	...
	struct FExpressionInput                            LayerInput;                                               // 0x000C(0x0014) (CPF_NoDestructor, CPF_NativeAccessSpecifierPublic)
	struct FExpressionInput                            HeightInput;                                              // 0x0020(0x0014) (CPF_NoDestructor, CPF_NativeAccessSpecifierPublic)
...
{
	struct FHeightmapData                              HeightmapData;                                            // 0x0000(0x0008) (CPF_NoDestructor, CPF_NativeAccessSpecifierPublic)
