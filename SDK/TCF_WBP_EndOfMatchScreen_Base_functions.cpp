...
#include "TCF_WBP_EndOfMatchScreen_Base_classes.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_EndOfMatchScreen_Base.WBP_EndOfMatchScreen_Base_C.SendBIEventForStage"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_EndOfMatchScreen_Base.WBP_EndOfMatchScreen_Base_C.OnStageUpdated"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_EndOfMatchScreen_Base.WBP_EndOfMatchScreen_Base_C.SetStage"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_EndOfMatchScreen_Base.WBP_EndOfMatchScreen_Base_C.Skip"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_EndOfMatchScreen_Base.WBP_EndOfMatchScreen_Base_C.IsAnyAnimPlaying"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_EndOfMatchScreen_Base.WBP_EndOfMatchScreen_Base_C.PlayAnim"));
