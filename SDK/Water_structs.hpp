...
struct FSphericalPontoon
{
	...
	unsigned char                                      UnknownData01[0x178];                                     // 0x0090(0x0178) MISSED OFFSET
	class AWaterBody*                                  CurrentWaterBody;                                         // 0x0208(0x0008) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
...
struct FUnderwaterPostProcessSettings
{
	...
	struct FPostProcessSettings                        PostProcessSettings;                                      // 0x0010(0x04F0) (CPF_Edit, CPF_BlueprintVisible, CPF_NativeAccessSpecifierPublic)
	class UMaterialInterface*                          UnderwaterPostProcessMaterial;                            // 0x0500(0x0008) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
...
struct FWaterBrushEffects
{
	...
	struct FWaterBrushEffectSmoothBlending             SmoothBlending;                                           // 0x0040(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_NoDestructor, CPF_NativeAccessSpecifierPublic)
