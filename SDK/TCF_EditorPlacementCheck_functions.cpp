...
#include "TCF_EditorPlacementCheck_classes.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function EditorPlacementCheck.EditorPlacementCheck_C.FindCornerPointsFromMesh"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function EditorPlacementCheck.EditorPlacementCheck_C.LootOnTheFloor"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function EditorPlacementCheck.EditorPlacementCheck_C.GetInteractableTestPoints"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function EditorPlacementCheck.EditorPlacementCheck_C.CheckPlacement"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function EditorPlacementCheck.EditorPlacementCheck_C.ExecuteUbergraph_EditorPlacementCheck"));
