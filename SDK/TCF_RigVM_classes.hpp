...
{
public:
	struct FRigVMMemoryContainer                       WorkMemoryStorage;                                        // 0x0028(0x00A0) (CPF_NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData00[0x8];                                       // 0x00C8(0x0008) MISSED OFFSET
	struct FRigVMMemoryContainer                       LiteralMemoryStorage;                                     // 0x00D0(0x00A0) (CPF_NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData01[0x8];                                       // 0x0170(0x0008) MISSED OFFSET
	struct FRigVMByteCode                              ByteCodeStorage;                                          // 0x0178(0x0030) (CPF_NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData02[0x8];                                       // 0x01A8(0x0008) MISSED OFFSET
	struct FRigVMInstructionArray                      Instructions;                                             // 0x01B0(0x0010) (CPF_Transient, CPF_NativeAccessSpecifierPrivate)
	struct FRigVMExecuteContext                        Context;                                                  // 0x01C0(0x0058) (CPF_Transient, CPF_NativeAccessSpecifierPrivate)
	TArray<struct FName>                               FunctionNamesStorage;                                     // 0x0218(0x0010) (CPF_ZeroConstructor, CPF_NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData03[0x20];                                      // 0x0228(0x0020) MISSED OFFSET
	TArray<struct FRigVMParameter>                     Parameters;                                               // 0x0248(0x0010) (CPF_ZeroConstructor, CPF_NativeAccessSpecifierPrivate)
	TMap<struct FName, int>                            ParametersNameMap;                                        // 0x0258(0x0050) (CPF_NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData04[0x48];                                      // 0x02A8(0x0048) MISSED OFFSET
	class URigVM*                                      DeferredVMToCopy;                                         // 0x02F0(0x0008) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPrivate)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>("Class RigVM.RigVM");
		return ptr;
	}
