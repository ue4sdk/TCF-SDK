...
#include "BTTask_Friendly_SetAlerted_classes.hpp"
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BTTask_Friendly_SetAlerted.BTTask_Friendly_SetAlerted_C.ReceiveExecuteAI"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BTTask_Friendly_SetAlerted.BTTask_Friendly_SetAlerted_C.ExecuteUbergraph_BTTask_Friendly_SetAlerted"));
