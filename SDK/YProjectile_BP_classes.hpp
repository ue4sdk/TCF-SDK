...
#include "YProjectile_BP_structs.hpp"
...
class AYProjectile_BP_C : public AYProjectile
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass YProjectile_BP.YProjectile_BP_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_YProjectile_BP(int EntryPoint);
};
