...
#include "TCF_PlayerBotTPInRangeTask_structs.hpp"
...
class UPlayerBotTPInRangeTask_C : public UBTTask_BlueprintBase
{
public:
	...
	float                                              TimeToTP;                                                 // 0x00F0(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
	float                                              InRange;                                                  // 0x00F4(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass PlayerBotTPInRangeTask.PlayerBotTPInRangeTask_C");
		return ptr;
	}


	void ReceiveExecute(class AActor* ownerActor);
	void ExecuteUbergraph_PlayerBotTPInRangeTask(int EntryPoint);
};
