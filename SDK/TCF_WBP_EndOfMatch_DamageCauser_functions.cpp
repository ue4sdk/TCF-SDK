...
#include "TCF_WBP_EndOfMatch_DamageCauser_classes.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_EndOfMatch_DamageCauser.WBP_EndOfMatch_DamageCauser_C.CreateDamgeSourceWidget"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_EndOfMatch_DamageCauser.WBP_EndOfMatch_DamageCauser_C.GetDamageApplyInfoRow"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_EndOfMatch_DamageCauser.WBP_EndOfMatch_DamageCauser_C.GetDamageCauerInfoRow"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_EndOfMatch_DamageCauser.WBP_EndOfMatch_DamageCauser_C.GetDamageItemId"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_EndOfMatch_DamageCauser.WBP_EndOfMatch_DamageCauser_C.OnLoaded_3A4395644A59B708232AAAA6F6E1EA98"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_EndOfMatch_DamageCauser.WBP_EndOfMatch_DamageCauser_C.SetupIconTexture"));
...
// (FUNC_BlueprintCallable, FUNC_BlueprintEvent)
// Parameters:
// struct FYDamageCauserInfo      DamageCauserInfo               (CPF_ConstParm, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_Parm, CPF_NoDestructor)

void UWBP_EndOfMatch_DamageCauser_C::SetupDamageCauser(const struct FYDamageCauserInfo& DamageCauserInfo)
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_EndOfMatch_DamageCauser.WBP_EndOfMatch_DamageCauser_C.SetupDamageCauser"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_EndOfMatch_DamageCauser.WBP_EndOfMatch_DamageCauser_C.CollapseAllDynamicElements"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_EndOfMatch_DamageCauser.WBP_EndOfMatch_DamageCauser_C.SetupDamageSourceName"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_EndOfMatch_DamageCauser.WBP_EndOfMatch_DamageCauser_C.SetupAsCondensedDamageEvent"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_EndOfMatch_DamageCauser.WBP_EndOfMatch_DamageCauser_C.ExecuteUbergraph_WBP_EndOfMatch_DamageCauser"));
