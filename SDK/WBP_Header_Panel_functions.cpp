...
#include "WBP_Header_Panel_classes.hpp"
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function WBP_Header_Panel.WBP_Header_Panel_C.BP_AnimateVisibility"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function WBP_Header_Panel.WBP_Header_Panel_C.PreConstruct"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function WBP_Header_Panel.WBP_Header_Panel_C.Construct"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function WBP_Header_Panel.WBP_Header_Panel_C.ExecuteUbergraph_WBP_Header_Panel"));
