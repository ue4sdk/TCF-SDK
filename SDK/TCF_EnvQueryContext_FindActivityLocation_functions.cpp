...
#include "TCF_EnvQueryContext_FindActivityLocation_classes.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function EnvQueryContext_FindActivityLocation.EnvQueryContext_FindActivityLocation_C.ProvideSingleLocation"));
