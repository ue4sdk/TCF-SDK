...
#include "TCF_LightningStrike_BP_classes.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function LightningStrike_BP.LightningStrike_BP_C.GetDamageRadius"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function LightningStrike_BP.LightningStrike_BP_C.GetWarningTime"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function LightningStrike_BP.LightningStrike_BP_C.OnWarningTimeOver"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function LightningStrike_BP.LightningStrike_BP_C.DoDamage"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function LightningStrike_BP.LightningStrike_BP_C.BndEvt__YDataTableRowAssociation_K2Node_ComponentBoundEvent_0_OnRowHandleChanged__DelegateSignature"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function LightningStrike_BP.LightningStrike_BP_C.InitializeLightningStrike"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function LightningStrike_BP.LightningStrike_BP_C.ExecuteUbergraph_LightningStrike_BP"));
