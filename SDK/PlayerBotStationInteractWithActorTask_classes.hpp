...
#include "PlayerBotStationInteractWithActorTask_structs.hpp"
...
public:
	...
	class APRO_PlayerController_C*                     PROPlayerController;                                      // 0x00C8(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnTemplate, CPF_DisableEditOnInstance, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
	...
	class UBlackboardComponent*                        Blackboard;                                               // 0x00E0(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_InstancedReference, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass PlayerBotStationInteractWithActorTask.PlayerBotStationInteractWithActorTask_C"));
		return ptr;
	}
