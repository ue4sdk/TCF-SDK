...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function WBP_ProgressBar.WBP_ProgressBar_C.Tick"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function WBP_ProgressBar.WBP_ProgressBar_C.ExecuteUbergraph_WBP_ProgressBar"));
