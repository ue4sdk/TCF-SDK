...
#include "TCF_LightningFunctions_BP_classes.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function LightningFunctions_BP.LightningFunctions_BP_C.IsStormLightningDebugEnabled"));
