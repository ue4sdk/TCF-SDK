...
#include "TCF_WBP_Weapon_HUD_Item_classes.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_Weapon_HUD_Item.WBP_Weapon_HUD_Item_C.SetMaxAmmo"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_Weapon_HUD_Item.WBP_Weapon_HUD_Item_C.PreConstruct"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_Weapon_HUD_Item.WBP_Weapon_HUD_Item_C.Construct"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_Weapon_HUD_Item.WBP_Weapon_HUD_Item_C.BndEvt__ItemComponent_Image_WBP_K2Node_ComponentBoundEvent_0_OnItemComponentImageLoaded__DelegateSignature"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_Weapon_HUD_Item.WBP_Weapon_HUD_Item_C.BndEvt__ItemComponent_TextName_WBP_K2Node_ComponentBoundEvent_1_OnItemComponentTextSet__DelegateSignature"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_Weapon_HUD_Item.WBP_Weapon_HUD_Item_C.BndEvt__ItemComponent_RarityColor_K2Node_ComponentBoundEvent_2_OnItemRarityColorSet__DelegateSignature"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_Weapon_HUD_Item.WBP_Weapon_HUD_Item_C.ItemSet"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_Weapon_HUD_Item.WBP_Weapon_HUD_Item_C.BndEvt__ItemComponent_AmmoAmountText_WBP_K2Node_ComponentBoundEvent_4_OnItemComponentTextAmountUpdated__DelegateSignature"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_Weapon_HUD_Item.WBP_Weapon_HUD_Item_C.ExecuteUbergraph_WBP_Weapon_HUD_Item"));
