...
struct FRigVMStatistics
{
	...
	struct FRigVMMemoryStatistics                      LiteralMemory;                                            // 0x0008(0x000C) (CPF_Edit, CPF_EditConst, CPF_NoDestructor, CPF_NativeAccessSpecifierPublic)
	struct FRigVMMemoryStatistics                      WorkMemory;                                               // 0x0014(0x000C) (CPF_Edit, CPF_EditConst, CPF_NoDestructor, CPF_NativeAccessSpecifierPublic)
	...
	struct FRigVMByteCodeStatistics                    ByteCode;                                                 // 0x0024(0x0008) (CPF_Edit, CPF_EditConst, CPF_NoDestructor, CPF_NativeAccessSpecifierPublic)
};
