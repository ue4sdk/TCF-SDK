...
#include "AnimNotify_AIRangedAttack_structs.hpp"
...
{
public:
	struct FDataTableRowHandle                         rangedAttackDefinitionRowhandle;                          // 0x0040(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_NoDestructor)
