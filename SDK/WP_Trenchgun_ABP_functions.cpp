...
#include "WP_Trenchgun_ABP_classes.hpp"
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function WP_Trenchgun_ABP.WP_Trenchgun_ABP_C.AnimGraph"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function WP_Trenchgun_ABP.WP_Trenchgun_ABP_C.BlueprintUpdateAnimation"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function WP_Trenchgun_ABP.WP_Trenchgun_ABP_C.OnAmmoChanged_Event_2"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function WP_Trenchgun_ABP.WP_Trenchgun_ABP_C.SetIsInCustomizationMode"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function WP_Trenchgun_ABP.WP_Trenchgun_ABP_C.IsTargeting"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function WP_Trenchgun_ABP.WP_Trenchgun_ABP_C.stopTargeting"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function WP_Trenchgun_ABP.WP_Trenchgun_ABP_C.BlueprintInitializeAnimation"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function WP_Trenchgun_ABP.WP_Trenchgun_ABP_C.ExecuteUbergraph_WP_Trenchgun_ABP"));
