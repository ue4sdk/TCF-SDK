...
#include "TCF_AMB_MatchPhaseManager_BP_classes.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function AMB_MatchPhaseManager_BP.AMB_MatchPhaseManager_BP_C.SetSoundProperties"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function AMB_MatchPhaseManager_BP.AMB_MatchPhaseManager_BP_C.ReceiveBeginPlay"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function AMB_MatchPhaseManager_BP.AMB_MatchPhaseManager_BP_C.BndEvt__MatchPhaseListenerComponent_BP_K2Node_ComponentBoundEvent_0_OnMatchPhaseVisualsUpdated__DelegateSignature"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function AMB_MatchPhaseManager_BP.AMB_MatchPhaseManager_BP_C.ExecuteUbergraph_AMB_MatchPhaseManager_BP"));
