...
#include "PlayerBotDoScreenshotTask_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass PlayerBotDoScreenshotTask.PlayerBotDoScreenshotTask_C"));
		return ptr;
	}
