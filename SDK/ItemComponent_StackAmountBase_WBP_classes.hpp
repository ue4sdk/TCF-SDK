...
#include "ItemComponent_StackAmountBase_WBP_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("WidgetBlueprintGeneratedClass ItemComponent_StackAmountBase_WBP.ItemComponent_StackAmountBase_WBP_C"));
		return ptr;
	}
