...
#include "TCF_AnimNotify_AIRangedAttack_classes.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function AnimNotify_AIRangedAttack.AnimNotify_AIRangedAttack_C.Received_Notify"));
