...
#include "GameModeHelperFunctions_BP_classes.hpp"
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function GameModeHelperFunctions_BP.GameModeHelperFunctions_BP_C.CreateIDFromActorLocation"));
