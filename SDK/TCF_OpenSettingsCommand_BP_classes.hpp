...
#include "TCF_OpenSettingsCommand_BP_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass OpenSettingsCommand_BP.OpenSettingsCommand_BP_C");
		return ptr;
	}
