...
#include "TCF_SplineAudioComponent_BP_classes.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function SplineAudioComponent_BP.SplineAudioComponent_BP_C.ReceiveTick"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function SplineAudioComponent_BP.SplineAudioComponent_BP_C.ReceiveBeginPlay"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function SplineAudioComponent_BP.SplineAudioComponent_BP_C.ExecuteUbergraph_SplineAudioComponent_BP"));
