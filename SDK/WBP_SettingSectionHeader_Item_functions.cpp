...
#include "WBP_SettingSectionHeader_Item_classes.hpp"
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function WBP_SettingSectionHeader_Item.WBP_SettingSectionHeader_Item_C.PreConstruct"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function WBP_SettingSectionHeader_Item.WBP_SettingSectionHeader_Item_C.ExecuteUbergraph_WBP_SettingSectionHeader_Item"));
