...
struct FMovieSceneActorReferenceData : public FMovieSceneChannel
{
	...
	struct FMovieSceneActorReferenceKey                DefaultValue;                                             // 0x0018(0x0028) (CPF_NoDestructor, CPF_NativeAccessSpecifierPrivate)
...
{
	class UClass* /*UCameraShakeBase*/                 ShakeClass;                                               // 0x0000(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_UObjectWrapper, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
