...
#include "TCF_AnimNotify_PlayEffort_classes.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AnimNotify_PlayEffort.AnimNotify_PlayEffort_C.Received_Notify");
