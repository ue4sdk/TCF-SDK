...
#include "Basic.hpp"
#include "YInitializationPlugin_enums.hpp"
...
struct FYInitializationRequestEntry
{
	...
	struct FScriptDelegate                             m_bpDelegate;                                             // 0x0018(0x0010) (CPF_ZeroConstructor, CPF_InstancedReference, CPF_NoDestructor, CPF_NativeAccessSpecifierPublic)
...
struct FYRuntimeInitializationContext
{
	...
	struct FString                                     m_additionalInitializedDebugString;                       // 0x0028(0x0010) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
	bool                                               m_isAdditionalIntialized;                                 // 0x0038(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
	EYInitializationRequestSettingTypes                m_requestSettingType;                                     // 0x0039(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
