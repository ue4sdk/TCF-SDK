...
#include "BP_AimAssistInterface_classes.hpp"
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_AimAssistInterface.BP_AimAssistInterface_C.GetAutoAimRotator"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_AimAssistInterface.BP_AimAssistInterface_C.CharacterChangeState"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_AimAssistInterface.BP_AimAssistInterface_C.InitializeAimAssistWPNPreset"));
