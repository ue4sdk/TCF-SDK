...
#include "ItemComponent_ItemTags_WBP_structs.hpp"
...
// WidgetBlueprintGeneratedClass ItemComponent_ItemTags_WBP.ItemComponent_ItemTags_WBP_C
// 0x0018 (0x0328 - 0x0310)
class UItemComponent_ItemTags_WBP_C : public UYWidget_ItemComponentBase
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("WidgetBlueprintGeneratedClass ItemComponent_ItemTags_WBP.ItemComponent_ItemTags_WBP_C"));
		return ptr;
	}


	void BP_HandleSetItem();
	void ExecuteUbergraph_ItemComponent_ItemTags_WBP(int EntryPoint);
