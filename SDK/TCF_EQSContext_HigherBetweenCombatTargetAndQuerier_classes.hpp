...
#include "TCF_EQSContext_HigherBetweenCombatTargetAndQuerier_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass EQSContext_HigherBetweenCombatTargetAndQuerier.EQSContext_HigherBetweenCombatTargetAndQuerier_C");
		return ptr;
	}
