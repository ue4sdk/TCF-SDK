...
#include "BTTask_Friendly_Curious_GoTo_structs.hpp"
...
public:
	...
	struct FBlackboardKeySelector                      TargetToFollow;                                           // 0x00C0(0x0028) (CPF_Edit, CPF_BlueprintVisible)
	struct FBlackboardKeySelector                      Alerted;                                                  // 0x00E8(0x0028) (CPF_Edit, CPF_BlueprintVisible)
	float                                              AcceptanceRadius;                                         // 0x0110(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0114(0x0004) MISSED OFFSET
	struct FBlackboardKeySelector                      IsCreatureHappy;                                          // 0x0118(0x0028) (CPF_Edit, CPF_BlueprintVisible)
