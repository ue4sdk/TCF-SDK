...
#include "TCF_WBP_Options_Provider_structs.hpp"
...
{
public:
	struct FPointerToUberGraphFrame                    UberGraphFrame;                                           // 0x0090(0x0008) (CPF_ZeroConstructor, CPF_Transient, CPF_DuplicateTransient)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass WBP_Options_Provider.WBP_Options_Provider_C");
		return ptr;
	}
