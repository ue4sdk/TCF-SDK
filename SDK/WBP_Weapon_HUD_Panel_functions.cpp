...
#include "WBP_Weapon_HUD_Panel_classes.hpp"
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function WBP_Weapon_HUD_Panel.WBP_Weapon_HUD_Panel_C.IsValidWeaponIndex"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function WBP_Weapon_HUD_Panel.WBP_Weapon_HUD_Panel_C.SetWeaponData"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function WBP_Weapon_HUD_Panel.WBP_Weapon_HUD_Panel_C.SwapWeapons"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function WBP_Weapon_HUD_Panel.WBP_Weapon_HUD_Panel_C.UpdateWeaponsData"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function WBP_Weapon_HUD_Panel.WBP_Weapon_HUD_Panel_C.PreConstruct"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function WBP_Weapon_HUD_Panel.WBP_Weapon_HUD_Panel_C.ExecuteUbergraph_WBP_Weapon_HUD_Panel"));
