...
#include "AAM_StormMineral_BP_structs.hpp"
...
public:
	...
	TArray<class UYActivityComponent*>                 m_spawnedActivityComponents;                              // 0x0300(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_DisableEditOnInstance, CPF_ContainsInstancedReference)
	bool                                               IsActivityActive;                                         // 0x0310(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData, CPF_NoDestructor)
