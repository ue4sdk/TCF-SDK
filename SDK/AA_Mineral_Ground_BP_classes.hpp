...
#include "AA_Mineral_Ground_BP_structs.hpp"
...
public:
	...
	class UBoxComponent*                               PawnBoxCollision;                                         // 0x0520(0x0008) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData, CPF_NonTransactional, CPF_NoDestructor, CPF_HasGetValueTypeHash)
