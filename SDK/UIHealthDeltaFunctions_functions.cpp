...
#include "UIHealthDeltaFunctions_classes.hpp"
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UIHealthDeltaFunctions.UIHealthDeltaFunctions_C.UpdateDeltaProgressBar"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UIHealthDeltaFunctions.UIHealthDeltaFunctions_C.SetupShowDeltaHealth"));
