...
#include "TCF_StationDropPod_ABP_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("AnimBlueprintGeneratedClass StationDropPod_ABP.StationDropPod_ABP_C");
		return ptr;
	}
