...
#include "TCF_AAM_LootPoints_BP_classes.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function AAM_LootPoints_BP.AAM_LootPoints_BP_C.BP_SpawnActivityActorFromToken"));
