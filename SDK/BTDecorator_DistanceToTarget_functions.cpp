...
#include "BTDecorator_DistanceToTarget_classes.hpp"
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BTDecorator_DistanceToTarget.BTDecorator_DistanceToTarget_C.PerformConditionCheckAI"));
