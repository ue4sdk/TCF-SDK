...
#include "TCF_UI_KeyShortcut_WBP_classes.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function UI_KeyShortcut_WBP.UI_KeyShortcut_WBP_C.GetLocalizedKeyText");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function UI_KeyShortcut_WBP.UI_KeyShortcut_WBP_C.AzertyHandling");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function UI_KeyShortcut_WBP.UI_KeyShortcut_WBP_C.PreConstruct");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function UI_KeyShortcut_WBP.UI_KeyShortcut_WBP_C.Construct");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function UI_KeyShortcut_WBP.UI_KeyShortcut_WBP_C.SetKeyShortcutText");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function UI_KeyShortcut_WBP.UI_KeyShortcut_WBP_C.SettingText");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function UI_KeyShortcut_WBP.UI_KeyShortcut_WBP_C.SettingsUpdated");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function UI_KeyShortcut_WBP.UI_KeyShortcut_WBP_C.ExecuteUbergraph_UI_KeyShortcut_WBP");
