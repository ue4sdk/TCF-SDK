...
#include "MapMarker_DeliveryStation_WBP_classes.hpp"
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function MapMarker_DeliveryStation_WBP.MapMarker_DeliveryStation_WBP_C.BP_OnUpdateMarkerData"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function MapMarker_DeliveryStation_WBP.MapMarker_DeliveryStation_WBP_C.ExecuteUbergraph_MapMarker_DeliveryStation_WBP"));
