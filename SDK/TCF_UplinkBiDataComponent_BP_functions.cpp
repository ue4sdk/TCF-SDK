...
#include "TCF_UplinkBiDataComponent_BP_classes.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function UplinkBiDataComponent_BP.UplinkBiDataComponent_BP_C.SendBIDataEvent"));
