...
#include "WBP_SocialToggle_classes.hpp"
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function WBP_SocialToggle.WBP_SocialToggle_C.Get_SocialButton_ToolTipWidget"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function WBP_SocialToggle.WBP_SocialToggle_C.BndEvt__SquadToggleButton_K2Node_ComponentBoundEvent_1_OnButtonHoverEvent__DelegateSignature"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function WBP_SocialToggle.WBP_SocialToggle_C.BndEvt__SquadToggleButton_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function WBP_SocialToggle.WBP_SocialToggle_C.BP_SetNumberOfOnlineFriends"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function WBP_SocialToggle.WBP_SocialToggle_C.BndEvt__SquadToggleButton_K2Node_ComponentBoundEvent_0_OnButtonHoverEvent__DelegateSignature"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function WBP_SocialToggle.WBP_SocialToggle_C.BP_SetNumberOfInvites"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function WBP_SocialToggle.WBP_SocialToggle_C.ExecuteUbergraph_WBP_SocialToggle"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function WBP_SocialToggle.WBP_SocialToggle_C.OnSocialToggleClicked__DelegateSignature"));
