...
#include "TCF_NaturalLoot_Base_BP_classes.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function NaturalLoot_Base_BP.NaturalLoot_Base_BP_C.ReceiveBeginPlay"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function NaturalLoot_Base_BP.NaturalLoot_Base_BP_C.RespawnLoot"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function NaturalLoot_Base_BP.NaturalLoot_Base_BP_C.BP_OnCollectedByPlayer_Event_1"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function NaturalLoot_Base_BP.NaturalLoot_Base_BP_C.TriggerRespawn"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function NaturalLoot_Base_BP.NaturalLoot_Base_BP_C.ExecuteUbergraph_NaturalLoot_Base_BP"));
