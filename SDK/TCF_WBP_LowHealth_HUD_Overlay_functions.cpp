...
#include "TCF_WBP_LowHealth_HUD_Overlay_classes.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_LowHealth_HUD_Overlay.WBP_LowHealth_HUD_Overlay_C.GetPlayerCharacter"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_LowHealth_HUD_Overlay.WBP_LowHealth_HUD_Overlay_C.Construct"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_LowHealth_HUD_Overlay.WBP_LowHealth_HUD_Overlay_C.CurrentHealthChangedDelegate_Event_1"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_LowHealth_HUD_Overlay.WBP_LowHealth_HUD_Overlay_C.ExecuteUbergraph_WBP_LowHealth_HUD_Overlay"));
