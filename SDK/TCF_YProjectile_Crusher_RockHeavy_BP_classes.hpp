...
#include "TCF_YProjectile_Crusher_RockHeavy_BP_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass YProjectile_Crusher_RockHeavy_BP.YProjectile_Crusher_RockHeavy_BP_C");
		return ptr;
	}
