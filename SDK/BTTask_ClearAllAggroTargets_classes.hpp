...
#include "BTTask_ClearAllAggroTargets_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BTTask_ClearAllAggroTargets.BTTask_ClearAllAggroTargets_C"));
		return ptr;
	}
