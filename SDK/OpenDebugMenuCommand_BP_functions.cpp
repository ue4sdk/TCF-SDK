...
#include "OpenDebugMenuCommand_BP_classes.hpp"
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function OpenDebugMenuCommand_BP.OpenDebugMenuCommand_BP_C.BP_IsAvailable"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function OpenDebugMenuCommand_BP.OpenDebugMenuCommand_BP_C.BP_OnExecute"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function OpenDebugMenuCommand_BP.OpenDebugMenuCommand_BP_C.ExecuteUbergraph_OpenDebugMenuCommand_BP"));
