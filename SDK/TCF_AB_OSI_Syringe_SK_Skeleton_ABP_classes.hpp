...
#include "TCF_AB_OSI_Syringe_SK_Skeleton_ABP_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("AnimBlueprintGeneratedClass AB_OSI_Syringe_SK_Skeleton_ABP.AB_OSI_Syringe_SK_Skeleton_ABP_C");
		return ptr;
	}
