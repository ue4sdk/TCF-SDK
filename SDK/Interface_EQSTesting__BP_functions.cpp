...
#include "Interface_EQSTesting__BP_classes.hpp"
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Interface_EQSTesting__BP.Interface_EQSTesting__BP_C.GetCombatTarget"));
