...
struct FLightningTuningDataInfo
{
	...
	float                                              Damage_27_5819B0B94E931BEF3EFC4C8C73DF31F3;               // 0x0014(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
	float                                              DamageRadius_29_3438EAD94CEF46EF4A0BC0A172A69988;         // 0x0018(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
	bool                                               IsDebugForcedEnabled_34_0D770C7A476CD9B6A977AFB2D66EF13C; // 0x001C(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor)
};
