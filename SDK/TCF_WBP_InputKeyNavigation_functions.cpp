...
#include "TCF_WBP_InputKeyNavigation_classes.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_InputKeyNavigation.WBP_InputKeyNavigation_C.ClearInputKeys");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_InputKeyNavigation.WBP_InputKeyNavigation_C.GetWidgetForInputRow");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_InputKeyNavigation.WBP_InputKeyNavigation_C.CreateNavKeys");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_InputKeyNavigation.WBP_InputKeyNavigation_C.PreConstruct");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_InputKeyNavigation.WBP_InputKeyNavigation_C.Construct");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_InputKeyNavigation.WBP_InputKeyNavigation_C.AddNavItem");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_InputKeyNavigation.WBP_InputKeyNavigation_C.Refresh");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_InputKeyNavigation.WBP_InputKeyNavigation_C.ExecuteUbergraph_WBP_InputKeyNavigation");
