...
#include "PlayerBotDoPerformanceCaptureTask_classes.hpp"
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function PlayerBotDoPerformanceCaptureTask.PlayerBotDoPerformanceCaptureTask_C.ReceiveExecute"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function PlayerBotDoPerformanceCaptureTask.PlayerBotDoPerformanceCaptureTask_C.ExecuteUbergraph_PlayerBotDoPerformanceCaptureTask"));
