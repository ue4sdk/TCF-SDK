...
#include "TCF_Backend_classes.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Backend.YBackendInstance.OnPlayfabServerLogin");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Backend.YBackendInstance.IsUsingExperimentalBackendLogin");
