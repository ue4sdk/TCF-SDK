...
#include "TCF_SplineToolFunctions_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass SplineToolFunctions.SplineToolFunctions_C");
		return ptr;
	}
