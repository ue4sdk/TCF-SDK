...
enum class EYLoginAuthType : uint8_t
{
	EYLoginAuthType__None          = 0,
	EYLoginAuthType__EgsToken      = 1,
	EYLoginAuthType__EgsDevTool    = 2,
	EYLoginAuthType__CustomId      = 3,
	EYLoginAuthType__Steam         = 4,
	EYLoginAuthType__EosOAuth      = 5,
	EYLoginAuthType__EYLoginAuthType_MAX = 6
};
