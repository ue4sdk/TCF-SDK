...
#include "FX_ScalabilityManager01_BP_classes.hpp"
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function FX_ScalabilityManager01_BP.FX_ScalabilityManager01_BP_C.ReceiveBeginPlay"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function FX_ScalabilityManager01_BP.FX_ScalabilityManager01_BP_C.OnSettingsAppliedMulticastDelegate"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function FX_ScalabilityManager01_BP.FX_ScalabilityManager01_BP_C.ExecuteUbergraph_FX_ScalabilityManager01_BP"));
