...
#include "AIRangedAttackFunctions_classes.hpp"
...
// Function AIRangedAttackFunctions.AIRangedAttackFunctions_C.DEPRECATED_DetermineProjectileTransportValuesFromRangedAttackDefinition
...
// bool                           useMovementPrediction          (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor)
// struct FVector                 OverrideAttackerLocation       (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
// class UObject*                 __WorldContext                 (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
// bool                           wasSuccessful                  (CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor)
// struct FVector                 ShootFromLocation              (CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
// struct FVector                 shootAtLocation                (CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
...
void UAIRangedAttackFunctions_C::DEPRECATED_DetermineProjectileTransportValuesFromRangedAttackDefinition(class AYAICharacter* AIAttacker, class AActor* Victim, const struct FYAIRangedAttackDefinitionNew& AIRangedAttackDefinition, class AYProjectile* PreSpawnedActor, bool useMovementPrediction, const struct FVector& OverrideAttackerLocation, class UObject* __WorldContext, bool* wasSuccessful, struct FVector* ShootFromLocation, struct FVector* shootAtLocation, struct FVector* LaunchVelocity, float* GravityZMultiplier)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AIRangedAttackFunctions.AIRangedAttackFunctions_C.DEPRECATED_DetermineProjectileTransportValuesFromRangedAttackDefinition"));
	...
	struct
	{
		...
		struct FVector                 OverrideAttackerLocation;
	...
	params.useMovementPrediction = useMovementPrediction;
	params.OverrideAttackerLocation = OverrideAttackerLocation;
	...
	if (ShootFromLocation != nullptr)
		*ShootFromLocation = params.ShootFromLocation;
	if (shootAtLocation != nullptr)
		*shootAtLocation = params.shootAtLocation;
...
// Function AIRangedAttackFunctions.AIRangedAttackFunctions_C.DEPRECATED_CanHitTargetWithProjectileFromRangedAttackDefinition
// (FUNC_Static, FUNC_Public, FUNC_HasOutParms, FUNC_HasDefaults, FUNC_BlueprintCallable, FUNC_BlueprintEvent)
// Parameters:
// class AYAICharacter*           AIAttacker                     (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
// class AActor*                  Victim                         (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
...
// struct FVector                 OverrideAttackerLocation       (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
// class UObject*                 __WorldContext                 (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
// bool                           CanHitTarget                   (CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor)

void UAIRangedAttackFunctions_C::DEPRECATED_CanHitTargetWithProjectileFromRangedAttackDefinition(class AYAICharacter* AIAttacker, class AActor* Victim, const struct FYAIRangedAttackDefinitionNew& AIRangedAttackDefinition, class AYProjectile* PreSpawnedActor, const struct FVector& OverrideAttackerLocation, class UObject* __WorldContext, bool* CanHitTarget)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AIRangedAttackFunctions.AIRangedAttackFunctions_C.DEPRECATED_CanHitTargetWithProjectileFromRangedAttackDefinition"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AIRangedAttackFunctions.AIRangedAttackFunctions_C.GetVFXDataFromWeaponTransportRowHandle"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AIRangedAttackFunctions.AIRangedAttackFunctions_C.PlayMuzzleFXFromRangedAttackDefinitionNew"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AIRangedAttackFunctions.AIRangedAttackFunctions_C.Fire Projectile Now from Ranged Attack Definition"));
...
// bool                           getTargetEyeLocation           (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor)
// class UObject*                 __WorldContext                 (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
...
void UAIRangedAttackFunctions_C::DetermineAttackLocation(class AActor* ActorVictim, bool getTargetEyeLocation, class UObject* __WorldContext, struct FVector* AttackLocation)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AIRangedAttackFunctions.AIRangedAttackFunctions_C.DetermineAttackLocation"));

	struct
	{
		class AActor*                  ActorVictim;
		bool                           getTargetEyeLocation;
		class UObject*                 __WorldContext;
		struct FVector                 AttackLocation;
	} params = {};

	params.ActorVictim = ActorVictim;
	params.getTargetEyeLocation = getTargetEyeLocation;
	params.__WorldContext = __WorldContext;
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AIRangedAttackFunctions.AIRangedAttackFunctions_C.DetermineVelocityLaunchFromRangedAttackDefinition"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AIRangedAttackFunctions.AIRangedAttackFunctions_C.DetermineVelocityLaunch"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AIRangedAttackFunctions.AIRangedAttackFunctions_C.DetermineTimeItTakesForProjectileToLocationFromRangedAttackDefinition"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AIRangedAttackFunctions.AIRangedAttackFunctions_C.DetermineTimeItTakesForProjectileToLocation"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AIRangedAttackFunctions.AIRangedAttackFunctions_C.ApplyWeaponSpread"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AIRangedAttackFunctions.AIRangedAttackFunctions_C.TryAdjustShootAtLocationByTraceDown"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AIRangedAttackFunctions.AIRangedAttackFunctions_C.Predicated Target LocationFromRangedAttackDefinition"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AIRangedAttackFunctions.AIRangedAttackFunctions_C.Predicated Target Location"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AIRangedAttackFunctions.AIRangedAttackFunctions_C.FireProjectileNow"));
