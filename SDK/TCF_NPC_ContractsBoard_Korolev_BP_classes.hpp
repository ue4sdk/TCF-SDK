...
#include "TCF_NPC_ContractsBoard_Korolev_BP_structs.hpp"
...
// BlueprintGeneratedClass NPC_ContractsBoard_Korolev_BP.NPC_ContractsBoard_Korolev_BP_C
// 0x0070 (0x0310 - 0x02A0)
class ANPC_ContractsBoard_Korolev_BP_C : public ANPC_Object_BP_C
{
public:
	...
	struct FVector                                     Timeline_0_Door_01_Location_D5F3B5D844C68E55514436B06EC38935;// 0x02E8(0x000C) (CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
	struct FVector                                     Timeline_0_Door_02_Location_D5F3B5D844C68E55514436B06EC38935;// 0x02F4(0x000C) (CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
	TEnumAsByte<ETimelineDirection>                    Timeline_0__Direction_D5F3B5D844C68E55514436B06EC38935;   // 0x0300(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass NPC_ContractsBoard_Korolev_BP.NPC_ContractsBoard_Korolev_BP_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_NPC_ContractsBoard_Korolev_BP(int EntryPoint);
};
