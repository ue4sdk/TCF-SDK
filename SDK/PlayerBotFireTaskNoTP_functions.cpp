...
#include "PlayerBotFireTaskNoTP_classes.hpp"
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function PlayerBotFireTaskNoTP.PlayerBotFireTaskNoTP_C.ReceiveExecute"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function PlayerBotFireTaskNoTP.PlayerBotFireTaskNoTP_C.ExecuteUbergraph_PlayerBotFireTaskNoTP"));
