...
#include "EndOfMatchFunctions_BP_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass EndOfMatchFunctions_BP.EndOfMatchFunctions_BP_C"));
		return ptr;
	}
