...
#include "TCF_WBP_Item_InsuranceTag_classes.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_Item_InsuranceTag.WBP_Item_InsuranceTag_C.BP_AnimateVisibility");
