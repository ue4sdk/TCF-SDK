...
#include "TCF_EH_HealingPod_BP_classes.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function EH_HealingPod_BP.EH_HealingPod_BP_C.BndEvt__CollisionSphere_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
...
// Function EH_HealingPod_BP.EH_HealingPod_BP_C.BndEvt__CollisionSphere_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature
// (FUNC_BlueprintEvent)
// Parameters:
// class UPrimitiveComponent*     OverlappedComponent            (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_Parm, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
// class AActor*                  OtherActor                     (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
...
void AEH_HealingPod_BP_C::BndEvt__CollisionSphere_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int OtherBodyIndex)
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function EH_HealingPod_BP.EH_HealingPod_BP_C.BndEvt__CollisionSphere_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature"));
...
// Function EH_HealingPod_BP.EH_HealingPod_BP_C.TriggerHealFX
// (FUNC_Net, FUNC_NetMulticast, FUNC_BlueprintCallable, FUNC_BlueprintEvent)

void AEH_HealingPod_BP_C::TriggerHealFX()
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function EH_HealingPod_BP.EH_HealingPod_BP_C.TriggerHealFX"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function EH_HealingPod_BP.EH_HealingPod_BP_C.ExecuteUbergraph_EH_HealingPod_BP"));
