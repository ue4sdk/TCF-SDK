...
#include "AITurn_AnimationFunctions_BP_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass AITurn_AnimationFunctions_BP.AITurn_AnimationFunctions_BP_C"));
		return ptr;
	}
