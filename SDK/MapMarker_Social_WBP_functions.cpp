...
#include "MapMarker_Social_WBP_classes.hpp"
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function MapMarker_Social_WBP.MapMarker_Social_WBP_C.IsOwnedByLocalPlayer"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function MapMarker_Social_WBP.MapMarker_Social_WBP_C.OnMouseButtonDown"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function MapMarker_Social_WBP.MapMarker_Social_WBP_C.BP_OnUpdateMarkerData"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function MapMarker_Social_WBP.MapMarker_Social_WBP_C.OnMouseEnter"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function MapMarker_Social_WBP.MapMarker_Social_WBP_C.OnMouseLeave"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function MapMarker_Social_WBP.MapMarker_Social_WBP_C.Construct"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function MapMarker_Social_WBP.MapMarker_Social_WBP_C.UpdateHoverIndicator"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function MapMarker_Social_WBP.MapMarker_Social_WBP_C.BP_OnAcknowledgedPlayerStatesChanged_Event_1"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function MapMarker_Social_WBP.MapMarker_Social_WBP_C.ExecuteUbergraph_MapMarker_Social_WBP"));
