...
#include "TCF_AIChar_Leafman_BP_classes.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function AIChar_Leafman_BP.AIChar_Leafman_BP_C.ReceiveBeginPlay"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function AIChar_Leafman_BP.AIChar_Leafman_BP_C.BndEvt__m_damageComponent_K2Node_ComponentBoundEvent_0_YTakeDamageEvent__DelegateSignature"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function AIChar_Leafman_BP.AIChar_Leafman_BP_C.ExecuteUbergraph_AIChar_Leafman_BP"));
