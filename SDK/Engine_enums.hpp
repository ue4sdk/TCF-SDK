...
enum class EFixedFoveationLevels : uint8_t
{
	...
	EFixedFoveationLevels__EFixedFoveationLevels_MAX = 4
};
...
enum class EYDataTableEditorForce : uint8_t
{
	EYDataTableEditorForce__None   = 0,
	EYDataTableEditorForce__UseYager = 1,
	EYDataTableEditorForce__UseEpic = 2,
	EYDataTableEditorForce__EYDataTableEditorForce_MAX = 3
};
