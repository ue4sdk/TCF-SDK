...
#include "TCF_ItemStatsFunctionLibrary_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass ItemStatsFunctionLibrary.ItemStatsFunctionLibrary_C");
		return ptr;
	}
