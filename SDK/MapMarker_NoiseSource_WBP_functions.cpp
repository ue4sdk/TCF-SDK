...
#include "MapMarker_NoiseSource_WBP_classes.hpp"
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function MapMarker_NoiseSource_WBP.MapMarker_NoiseSource_WBP_C.BP_OnUpdateMarkerData"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function MapMarker_NoiseSource_WBP.MapMarker_NoiseSource_WBP_C.Construct"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function MapMarker_NoiseSource_WBP.MapMarker_NoiseSource_WBP_C.ExecuteUbergraph_MapMarker_NoiseSource_WBP"));
