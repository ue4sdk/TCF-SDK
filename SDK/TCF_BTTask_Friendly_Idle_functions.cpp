...
#include "TCF_BTTask_Friendly_Idle_classes.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function BTTask_Friendly_Idle.BTTask_Friendly_Idle_C.ReceiveExecuteAI"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function BTTask_Friendly_Idle.BTTask_Friendly_Idle_C.ExecuteUbergraph_BTTask_Friendly_Idle"));
