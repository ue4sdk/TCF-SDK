...
#include "TCF_WBP_SquadOverview_structs.hpp"
...
public:
	...
	class UButton*                                     Btn_LeaveSquad;                                           // 0x02F0(0x0008) (CPF_BlueprintVisible, CPF_ExportObject, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData, CPF_RepSkip, CPF_NoDestructor, CPF_PersistentInstance, CPF_HasGetValueTypeHash)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>("WidgetBlueprintGeneratedClass WBP_SquadOverview.WBP_SquadOverview_C");
		return ptr;
	}
