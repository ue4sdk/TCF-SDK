...
#include "TCF_YChatFilteringPlugin_classes.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function YChatFilteringPlugin.YChatFilterExternalFunctions.ContainsProfanity");
