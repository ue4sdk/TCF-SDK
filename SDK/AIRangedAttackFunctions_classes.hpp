...
#include "AIRangedAttackFunctions_structs.hpp"
...
public:
	...
	static void DetermineAttackLocation(class AActor* ActorVictim, bool getTargetEyeLocation, class UObject* __WorldContext, struct FVector* AttackLocation);
