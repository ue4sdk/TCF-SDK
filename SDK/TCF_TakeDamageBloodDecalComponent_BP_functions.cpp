...
#include "TCF_TakeDamageBloodDecalComponent_BP_classes.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function TakeDamageBloodDecalComponent_BP.TakeDamageBloodDecalComponent_BP_C.BP_SpawnDamageDecal");
