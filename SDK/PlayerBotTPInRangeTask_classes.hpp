...
#include "PlayerBotTPInRangeTask_structs.hpp"
...
public:
	...
	float                                              InRange;                                                  // 0x00FC(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass PlayerBotTPInRangeTask.PlayerBotTPInRangeTask_C"));
		return ptr;
	}
