...
#include "TCF_AnimNotify_AICombo_classes.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AnimNotify_AICombo.AnimNotify_AICombo_C.Received_Notify");
