...
#include "TCF_WP_Scrapper_ABP_structs.hpp"
...
// AnimBlueprintGeneratedClass WP_Scrapper_ABP.WP_Scrapper_ABP_C
// 0x0369 (0x0629 - 0x02C0)
class UWP_Scrapper_ABP_C : public UAnimInstance
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("AnimBlueprintGeneratedClass WP_Scrapper_ABP.WP_Scrapper_ABP_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_WP_Scrapper_ABP(int EntryPoint);
};
