...
#include "AL_AIGuardians_BP_classes.hpp"
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AL_AIGuardians_BP.AL_AIGuardians_BP_C.DebugUpdateLinkedActors"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AL_AIGuardians_BP.AL_AIGuardians_BP_C.GetDebugDescription"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AL_AIGuardians_BP.AL_AIGuardians_BP_C.UserConstructionScript"));
