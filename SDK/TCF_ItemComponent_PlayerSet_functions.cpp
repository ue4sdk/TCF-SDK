...
#include "TCF_ItemComponent_PlayerSet_classes.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function ItemComponent_PlayerSet.ItemComponent_PlayerSet_C.SetInventoryId"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function ItemComponent_PlayerSet.ItemComponent_PlayerSet_C.UpdateAmmoWarning"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function ItemComponent_PlayerSet.ItemComponent_PlayerSet_C.HandleDrop"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function ItemComponent_PlayerSet.ItemComponent_PlayerSet_C.Construct"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function ItemComponent_PlayerSet.ItemComponent_PlayerSet_C.BP_HandleSetItem"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function ItemComponent_PlayerSet.ItemComponent_PlayerSet_C.ExecuteUbergraph_ItemComponent_PlayerSet"));
