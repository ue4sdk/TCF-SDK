...
#include "TCF_EndOfMatch_classes.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function EndOfMatch.EndOfMatch_C.BP_ShowEOM"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function EndOfMatch.EndOfMatch_C.ExecuteUbergraph_EndOfMatch"));
