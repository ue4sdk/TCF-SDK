...
{
	TArray<struct FGameplayTag>                        GameplayTags;                                             // 0x0000(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_EditConst, CPF_SaveGame, CPF_Protected, CPF_NativeAccessSpecifierProtected)
