...
#include "YProjectile_Crusher_RockHeavy_BP_structs.hpp"
...
class AYProjectile_Crusher_RockHeavy_BP_C : public AYProjectile_BP_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass YProjectile_Crusher_RockHeavy_BP.YProjectile_Crusher_RockHeavy_BP_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_YProjectile_Crusher_RockHeavy_BP(int EntryPoint);
};
