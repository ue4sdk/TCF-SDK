...
#include "TCF_WP_AR55_ABP_structs.hpp"
...
// AnimBlueprintGeneratedClass WP_AR55_ABP.WP_AR55_ABP_C
// 0x036A (0x062A - 0x02C0)
class UWP_AR55_ABP_C : public UAnimInstance
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("AnimBlueprintGeneratedClass WP_AR55_ABP.WP_AR55_ABP_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_WP_AR55_ABP(int EntryPoint);
};
