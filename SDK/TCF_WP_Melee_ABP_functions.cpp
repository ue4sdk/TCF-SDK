...
#include "TCF_WP_Melee_ABP_classes.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WP_Melee_ABP.WP_Melee_ABP_C.AnimGraph"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WP_Melee_ABP.WP_Melee_ABP_C.BlueprintUpdateAnimation"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WP_Melee_ABP.WP_Melee_ABP_C.SetIsInCustomizationMode"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WP_Melee_ABP.WP_Melee_ABP_C.ExecuteUbergraph_WP_Melee_ABP"));
