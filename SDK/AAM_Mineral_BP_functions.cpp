...
#include "AAM_Mineral_BP_classes.hpp"
...
void AAAM_Mineral_BP_C::GetActorClassToSpawn(class AYActivityLocation* Location, class UClass* /*AActor*/* ActivityActorClass)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AAM_Mineral_BP.AAM_Mineral_BP_C.GetActorClassToSpawn"));
