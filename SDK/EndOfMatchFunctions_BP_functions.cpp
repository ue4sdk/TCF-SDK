...
#include "EndOfMatchFunctions_BP_classes.hpp"
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function EndOfMatchFunctions_BP.EndOfMatchFunctions_BP_C.HasPlayerDied"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function EndOfMatchFunctions_BP.EndOfMatchFunctions_BP_C.TravelBackToStation"));
