...
#include "AAM_PowerUp_BP_structs.hpp"
...
public:
	...
	TArray<class AAA_Powerup_Configurator_BP_C*>       Configurators;                                            // 0x0300(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_DisableEditOnTemplate, CPF_DisableEditOnInstance)
