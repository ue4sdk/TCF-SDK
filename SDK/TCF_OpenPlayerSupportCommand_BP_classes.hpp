...
#include "TCF_OpenPlayerSupportCommand_BP_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass OpenPlayerSupportCommand_BP.OpenPlayerSupportCommand_BP_C");
		return ptr;
	}
