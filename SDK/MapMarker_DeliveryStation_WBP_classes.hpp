...
#include "MapMarker_DeliveryStation_WBP_structs.hpp"
...
public:
	...
	EYMapMarkerState                                   IconState;                                                // 0x0308(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("WidgetBlueprintGeneratedClass MapMarker_DeliveryStation_WBP.MapMarker_DeliveryStation_WBP_C"));
		return ptr;
	}
