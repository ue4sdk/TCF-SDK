...
#include "BP_RichTextDecorator_InputAction_classes.hpp"
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_RichTextDecorator_InputAction.BP_RichTextDecorator_InputAction_C.BP_InitInputWidget"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_RichTextDecorator_InputAction.BP_RichTextDecorator_InputAction_C.ExecuteUbergraph_BP_RichTextDecorator_InputAction"));
