...
#include "TCF_WP_Trenchgun_ABP_structs.hpp"
...
// AnimBlueprintGeneratedClass WP_Trenchgun_ABP.WP_Trenchgun_ABP_C
// 0x0376 (0x0636 - 0x02C0)
class UWP_Trenchgun_ABP_C : public UAnimInstance
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("AnimBlueprintGeneratedClass WP_Trenchgun_ABP.WP_Trenchgun_ABP_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_WP_Trenchgun_ABP(int EntryPoint);
};
