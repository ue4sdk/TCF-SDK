...
#include "TCF_PowerUpHelperFunctions_BP_classes.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function PowerUpHelperFunctions_BP.PowerUpHelperFunctions_BP_C.PowerupRelevantUpdate"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function PowerUpHelperFunctions_BP.PowerUpHelperFunctions_BP_C.FindConfigurator"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function PowerUpHelperFunctions_BP.PowerUpHelperFunctions_BP_C.HasRecentlyAttackedHostilePlayer"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function PowerUpHelperFunctions_BP.PowerUpHelperFunctions_BP_C.GetPowerUpActivity"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function PowerUpHelperFunctions_BP.PowerUpHelperFunctions_BP_C.DeterminePowerUpID"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function PowerUpHelperFunctions_BP.PowerUpHelperFunctions_BP_C.HasBeenRecentlyAttackedByHostilePlayer"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function PowerUpHelperFunctions_BP.PowerUpHelperFunctions_BP_C.SendPowerUpBiData"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function PowerUpHelperFunctions_BP.PowerUpHelperFunctions_BP_C.PropagatePowerStatus"));
